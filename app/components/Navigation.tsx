      ...
      <div className="container mx-auto max-w-6xl py-2 px-2">
        <div className="flex justify-between items-center">
          ...
          <div className="relative">
            <button
              className="p-2 rounded-md transform hover:scale-110 transition-transform duration-200"
              aria-label="Menu"
            ...
            <div 
              className={`absolute right-0 top-full mt-2 w-48 bg-backgroundLight rounded-md shadow-lg py-1 transition-opacity duration-150 ${
